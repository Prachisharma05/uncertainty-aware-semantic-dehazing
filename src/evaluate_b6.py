...
def evaluate():
    ...
    with torch.no_grad():
        for batch in tqdm(val_loader, desc="Evaluating B6"):
    ...
    results = {
        "model": "B6_FrozenBackbone_GatedCrossAttention",
    ...
    df.to_csv("results/b6/b6_metrics.csv", index=False)

    print("\n--- B6 Evaluation Results ---")
    print(df)
