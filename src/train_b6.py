...
def train():
    ...
    if os.path.exists(best_path):
        try:
            ...
            print(f"Best previous B6 val loss: {best_val_loss:.6f}")
        except RuntimeError:
            print("Existing B6 best checkpoint is corrupted. Ignoring it.")
    ...
    try:
        if os.path.exists(resume_path):
            ...
            print(f"Resumed B6 from last checkpoint epoch {checkpoint['epoch']}")
            ...
            print(f"Resumed B6 from best checkpoint epoch {checkpoint['epoch']}")

        else:
            print("No B6 checkpoint found. Starting from initialized B3 weights.")

    except RuntimeError:
        print("Corrupted B6 last checkpoint detected. Falling back to best checkpoint.")
        ...
        if os.path.exists(best_path):
            ...
            print("No valid B6 checkpoint found. Starting from initialized B3 weights.")
    ...
    if not os.path.exists(train_log_path) or start_epoch == 1:
        ...
        print("Existing B6 log file found. Appending resumed logs.")
    ...
    for epoch in range(start_epoch, config["training"]["epochs"] + 1):
        ...
        for batch in progress_bar:
            ...
            if torch.isnan(loss):
                print("NaN loss detected. Stopping B6 training.")
                return
        ...
        if avg_val_loss < best_val_loss:
            ...
            print(
                f"Best B6 model saved at epoch {epoch} "
